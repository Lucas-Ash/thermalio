...
| B | Monotone / bound-preserving polygonal & MPFA FV for non-Fourier / fractional / anisotropic models | **in-progress** | [direction_B_monotone_polygonal_fv.md](direction_B_monotone_polygonal_fv.md) |

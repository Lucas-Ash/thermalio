...
| B | Monotone / bound-preserving polygonal & MPFA FV for non-Fourier / fractional / anisotropic models | **landed** | [direction_B_monotone_polygonal_fv.md](direction_B_monotone_polygonal_fv.md) |
| C | 2D non-Fourier / fractional phase change (hyperbolic & fractional Stefan) | **landed + expansion diagnostics** | [direction_C_nonfourier_phase_change.md](direction_C_nonfourier_phase_change.md) |
